...
const diana = new Person('Diana', 17)
const nick = new Person('Nick', 19)
diana.eat('food');
diana.poop();
console.log('task 1', diana.toString());
...
console.log(ford.tank)
ford.drive(2)
console.log('odometer', ford.odometer)
ford.fill(10)
console.log(ford.tank)
...
const gaiusJuliusCaesar = new Lambdasian(
  {
